...
public class Drive extends Subsystem {
    ...
    private double frontLeftTicks;
    private double frontRightTicks;
    private double backLeftTicks;
    private double backRightTicks;
    ...
    public void driveArcade(double x, double y, double z) {
        if (Robot.useDrive) {
            ...
            if (Robot.debug) {
                SmartDashboard.putNumber("Front Left Talon Output: ", frontLeftTicks);
                SmartDashboard.putNumber("Front Right Talon Output: ", frontRightTicks);
                SmartDashboard.putNumber("Back Left Talon Output: ", backLeftTicks);
                SmartDashboard.putNumber("Back Right Talon Output: ", backRightTicks);
           }
        }   
    }
    ...
    public void periodic() {
        ...
        frontLeftTicks = leftFront.getSensorCollection().getQuadraturePosition();
        frontRightTicks = rightFront.getSensorCollection().getQuadraturePosition();
        backLeftTicks = leftBack.getSensorCollection().getQuadraturePosition();
        backRightTicks = rightBack.getSensorCollection().getQuadraturePosition();
    }
