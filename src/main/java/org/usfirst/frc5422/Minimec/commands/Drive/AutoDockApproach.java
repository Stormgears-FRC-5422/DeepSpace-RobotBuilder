...
public class AutoDockApproach extends Command {
    ...
    private Boolean m_pause = false; // State when PID control of drivetrain is suspended
    ...
    protected void execute() {
        if (Robot.useDrive) {
            ...
            if (joy.getRawButton(5) == true) {
                ...
                if (m_pause) set_navx_target(); // reset pid targets when first entering PID control
                m_pause = false;
