...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        useCompressor = StormProp.getBoolean("useCompressor");
        ...
        if(useCompressor)compressor.startCompressor();
    }
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        //System.out.println("WRIST POSITION: " + arm.getWristPosition());
        //System.out.println("WRIST VELOCITY: " + arm.getWristVelocity());
        //defaultDrive.start();
    }
