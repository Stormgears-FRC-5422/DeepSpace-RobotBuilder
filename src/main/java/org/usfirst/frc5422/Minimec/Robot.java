...
import org.usfirst.frc5422.Minimec.commands.Jack.ExtendJack;
...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        // Inverted camera on Pixy
        pixyVision = new PixyVision("vision", true); // FIXME - read table name from config file?
