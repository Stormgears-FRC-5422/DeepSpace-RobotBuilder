...
import org.usfirst.frc5422.utils.dsio.JoystickAxisButton;
...
public class OI {
    ...
    public DSIO dsio = new DSIO();
    public JoystickButton connectButton;
    public JoystickButton lineIR;
    ...
    public OI() {
        ...
        connectButton = new JoystickButton(joystick1, 1);
        lineIR = new JoystickButton(joystick1, 2);



        //connectButton.whenPressed(new StormConnect("10.54.22.177", 5422));
        //connectButton.whenPressed(new LineFollow());
